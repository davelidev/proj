...
class CC15_580(QCAlgorithm):
    ...
    def Rebalance(self):
        if self.IsWarmingUp or not self._bb.IsReady or not self.symbols: return
        pb=self._bb.PercentB.Current.Value
        if pb>0.5:
