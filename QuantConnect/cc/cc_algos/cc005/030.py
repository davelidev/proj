...
class TQQQPyramid20(QCAlgorithm):
    """Pyramid: +20% TQQQ each day in trend (5 days to full), full exit on bear flip."""
    def Initialize(self):
    ...
    def Rebalance(self):
        ...
        new_exp = min(1.0, self.exposure + 0.2) if bull else 0.0
