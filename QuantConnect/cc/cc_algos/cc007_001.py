...
class TS_R20_D300_50_50(QCAlgorithm):
    def Initialize(self):
        ...
        self.hi=self.MAX(self.qqq,300,Resolution.Daily); self.lo=self.MIN(self.qqq,300,Resolution.Daily)
        self.Schedule.On(self.DateRules.EveryDay(self.qqq), self.TimeRules.AfterMarketOpen(self.qqq,30), self.Rebalance)
        self.SetWarmUp(320, Resolution.Daily); self.state=None
    ...
    def Rebalance(self):
        ...
        if ns!=self.state: self.SetHoldings(self.tqqq,wt); self.SetHoldings(self.bil,wb); self.state=ns
