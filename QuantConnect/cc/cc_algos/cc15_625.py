...
class CC15_625(QCAlgorithm):
    def Initialize(self):
        ...
        self._mfi=self.MFI("QQQ",14,Resolution.Daily)
    ...
    def Rebalance(self):
        if self.IsWarmingUp or not self._mfi.IsReady or not self.symbols: return
        if self._mfi.Current.Value>50:
