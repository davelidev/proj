...
class RangeExp_DD_Top3(QCAlgorithm):
    def Initialize(self):
    ...
    def FineSelection(self, fine):
        ...
        return self.symbols
    def Rebalance(self):
        if self.IsWarmingUp or not self.hi60.IsReady or not self.symbols: return
        ...
        rng_b = recent_r > all_r * 1.1
        dd_b = self.Securities[self.qqq].Price / self.hi60.Current.Value > 0.95
        n = int(in_trend)+int(rng_b)+int(dd_b)
