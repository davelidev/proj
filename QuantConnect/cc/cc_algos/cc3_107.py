...
class ThreeState_3070_Trail6(QCAlgorithm):
    def Initialize(self):
    ...
    def Rebalance(self):
        if self.IsWarmingUp or not(self.roc.IsReady and self.hi200.IsReady and self.lo200.IsReady and self.hi20.IsReady): return
        ...
        m=self.roc.Current.Value>0; d=price>mid; trail_ok = dd > -0.06
        if m and d and trail_ok: ns,wt,wb="BULL",1.0,0.0
        elif (m or d) and trail_ok: ns,wt,wb="MIXED",0.3,0.7
