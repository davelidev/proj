...
class Mom20_ADX14_Top5_w70_21(QCAlgorithm):
    def Initialize(self):
        ...
        self.ind=self.ADX(self.qqq, 14, Resolution.Daily)
    ...
    def Rebalance(self):
        ...
        m = c[-1] > c[-20-1]
        i_b = self.ind.PositiveDirectionalIndex.Current.Value > self.ind.NegativeDirectionalIndex.Current.Value
