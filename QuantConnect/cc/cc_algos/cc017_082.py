...
class CC17_082(QCAlgorithm):
    def Initialize(self):
        ...
        self._atr={t:self.ATR(self.syms[t],14,MovingAverageType.Simple,Resolution.Daily) for t in self.tix}
        self._lb=252; self._pct=40; self._atrhist={t:[] for t in self.tix}
        self.SetWarmUp(271,Resolution.Daily)
