...
class DayOfWeekTQQQ(QCAlgorithm):
    def Initialize(self):
    ...
    def Rebalance(self):
        ...
        dow=self.Time.weekday()  # Mon=0,...,Fri=4
        # Hold TQQQ Tue-Fri while in trend; flat (BIL) on Mondays and bear
        favorable = (dow>=1) and in_trend
        if favorable:
