...
class TS_R20_D125_50_50(QCAlgorithm):
    def Initialize(self):
        ...
        self.hi=self.MAX(self.qqq,125,Resolution.Daily); self.lo=self.MIN(self.qqq,125,Resolution.Daily)
        self.Schedule.On(self.DateRules.EveryDay(self.qqq), self.TimeRules.AfterMarketOpen(self.qqq,30), self.Rebalance)
        self.SetWarmUp(145, Resolution.Daily); self.state=None
