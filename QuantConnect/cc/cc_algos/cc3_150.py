...
class TS_R20_D175_80_20(QCAlgorithm):
    def Initialize(self):
        ...
        self.hi=self.MAX(self.qqq,175,Resolution.Daily); self.lo=self.MIN(self.qqq,175,Resolution.Daily)
        self.Schedule.On(self.DateRules.EveryDay(self.qqq), self.TimeRules.AfterMarketOpen(self.qqq,30), self.Rebalance)
        self.SetWarmUp(195, Resolution.Daily); self.state=None
    ...
    def Rebalance(self):
        ...
        elif m or d: ns,wt,wb="MIXED",0.8,0.2
