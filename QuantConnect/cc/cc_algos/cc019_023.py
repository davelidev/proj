...
class CC19_023(QCAlgorithm):
    def Initialize(self):
        ...
        self._bb=self.BB(self.q,14,2.0,MovingAverageType.Simple,Resolution.Daily)
        self._atr=self.ATR(self.q,14,Resolution.Daily)
        self.km=1.5; self.syms=[]; self.st=None; self.SetWarmUp(max(14,14)+100,Resolution.Daily)
