...
class ADX_Median200(QCAlgorithm):
    def Initialize(self):
    ...
    def Rebalance(self):
        ...
        a=self.adx.Current.Value
        p=self.adx.PositiveDirectionalIndex.Current.Value
        n=self.adx.NegativeDirectionalIndex.Current.Value
        a_bull = a > 20 and p > n
        if in_trend and a_bull: ns,wt,wb="BULL",1.0,0.0
        elif in_trend or a_bull: ns,wt,wb="MIXED",0.5,0.5
