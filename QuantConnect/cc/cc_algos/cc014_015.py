...
class D3_M252_RNG_WVF_24(QCAlgorithm):
    def Initialize(self):
    ...
    def Rebalance(self):
        ...
        try:
            ...
            f3 = (self.hi22.Current.Value - self.Securities[self.qqq].Price)/self.hi22.Current.Value*100 < 5 if self.hi22.IsReady else False
