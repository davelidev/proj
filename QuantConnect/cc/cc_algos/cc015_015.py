...
class CC15_595(QCAlgorithm):
    def Initialize(self):
        ...
        self._sto=self.STO("QQQ",14,3,3,Resolution.Daily)
    ...
    def Rebalance(self):
        if self.IsWarmingUp or not self._sto.IsReady or not self.symbols: return
        k=self._sto.StochK.Current.Value; d=self._sto.StochD.Current.Value
        if k>d:
