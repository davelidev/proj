...
class CC15_635(QCAlgorithm):
    def Initialize(self):
        ...
        self._fish=self.FISH("QQQ",9,Resolution.Daily)
        self.SetWarmUp(20,Resolution.Daily); self._st=None; self.symbols=[]
    ...
    def Rebalance(self):
        if self.IsWarmingUp or not self._fish.IsReady or not self.symbols: return
        if self._fish.Current.Value>0:
