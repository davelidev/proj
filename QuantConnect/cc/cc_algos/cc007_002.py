...
class TS_R20_D150_70_30(QCAlgorithm):
    def Initialize(self):
        ...
        self.hi=self.MAX(self.qqq,150,Resolution.Daily); self.lo=self.MIN(self.qqq,150,Resolution.Daily)
        self.Schedule.On(self.DateRules.EveryDay(self.qqq), self.TimeRules.AfterMarketOpen(self.qqq,30), self.Rebalance)
        self.SetWarmUp(170, Resolution.Daily); self.state=None
