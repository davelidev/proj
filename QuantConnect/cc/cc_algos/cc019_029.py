...
class CC19_029(QCAlgorithm):
    def Initialize(self):
        ...
        self.thr=0.0; self.syms=[]; self.st=None; self.SetWarmUp(50+100,Resolution.Daily)
    ...
    def R(self):
        if self.IsWarmingUp or not self._sma.IsReady or not self.syms: return
