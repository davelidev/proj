...
class CC14_ADX10(QCAlgorithm):
    def Initialize(self):
        ...
        self._adx=self.ADX("QQQ",10,Resolution.Daily)
        self.SetWarmUp(35,Resolution.Daily); self.symbols=[]; self._st=None
    ...
    def Rebalance(self):
        ...
        if adx>25 and pdi>ndi: st=2
        elif adx>25 and ndi>pdi: st=0
        else: st=1
