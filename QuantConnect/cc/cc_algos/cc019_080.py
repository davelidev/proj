...
class CC19_080(QCAlgorithm):
    def Initialize(self):
        ...
        self.k1=2.0/(25+1); self.k2=2.0/(15+1); self.ks=2.0/(10+1)
        self.e1=None; self.e2=None; self.sig=None; self.prev_c=None
        self.use_sig=False; self.syms=[]; self.st=None; self.SetWarmUp(25+15+10+100,Resolution.Daily)
