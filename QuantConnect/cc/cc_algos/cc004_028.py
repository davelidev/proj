...
class ThreeState_ROC20_StrictThreshold(QCAlgorithm):
    """3-state ROC(20) > 1% (stricter bull threshold) + Donchian-200 midline."""
    def Initialize(self):
    ...
    def Rebalance(self):
        ...
        m = self.roc.Current.Value > 0.01  # 1% over 20 days
