...
class CC16_718(QCAlgorithm):
    ...
    def Rebalance(self):
        ...
        # 3 consecutive positive 5-day (weekly) periods
        w1=closes[-1]>closes[-6]; w2=closes[-6]>closes[-11]; w3=closes[-11]>closes[-16]
        st=1 if (w1 and w2 and w3) else 0
