...
class CC14_CCI40_Slow(QCAlgorithm):
    # CCI(40) slower/smoother; CCI>0 → TQQQ; CCI<-100 → BIL; else top-5
    def Initialize(self):
        ...
        self._cci=self.CCI("QQQ",40,MovingAverageType.Simple,Resolution.Daily)
