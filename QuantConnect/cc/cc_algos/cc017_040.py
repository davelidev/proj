...
class CC17_040(QCAlgorithm):
    def Initialize(self):
        ...
        self._atr=self.ATR(self.q,20,MovingAverageType.Simple,Resolution.Daily)
        self._mult=2.0; self._st=None
        self.SetWarmUp(max(20,20)+5,Resolution.Daily)
