...
class CC15_650(QCAlgorithm):
    def Initialize(self):
        ...
        self._wilr=self.WILR("QQQ",14,Resolution.Daily)
        self.SetWarmUp(25,Resolution.Daily); self._st=None; self.symbols=[]
    ...
    def Rebalance(self):
        if self.IsWarmingUp or not self._wilr.IsReady or not self.symbols: return
        if self._wilr.Current.Value>-50:
