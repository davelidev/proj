...
class CC19_064(QCAlgorithm):
    def Initialize(self):
        ...
        self._lrs=self.LRS(self.q,14,Resolution.Daily)
        self._std=self.STD(self.q,14,Resolution.Daily)
        self.std_thr=0.0; self.syms=[]; self.st=None; self.SetWarmUp(14+100,Resolution.Daily)
