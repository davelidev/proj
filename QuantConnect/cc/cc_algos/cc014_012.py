...
class CC14_Don55_20(QCAlgorithm):
    # Turtle Trader: enter on 55-day high, exit on 20-day low
    def Initialize(self):
    ...
    def Rebalance(self):
        ...
        h=self.History(self.qqq,57,Resolution.Daily)
        if h.empty or len(h)<57: return
        hi55=float(h['high'].iloc[-55:].max())
