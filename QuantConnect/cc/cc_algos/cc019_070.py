...
class CC19_070(QCAlgorithm):
    def Initialize(self):
        ...
        self._macd=self.MACD(self.q,8,21,1,Resolution.Daily)
        self.sp=10
        self.mw=RollingWindow[float](self.sp+1)
        self.kw=RollingWindow[float](self.sp+1)
        self.thr=50.0; self.syms=[]; self.st=None; self.SetWarmUp(21+self.sp*2+100,Resolution.Daily)
