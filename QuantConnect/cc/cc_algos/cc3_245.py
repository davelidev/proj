...
class YearEndRally(QCAlgorithm):
    def Initialize(self):
    ...
    def Rebalance(self):
        ...
        m, d = self.Time.month, self.Time.day
        santa = (m==12 and d>=15) or (m==1 and d<=5)
        if in_trend and santa: ns,wt,wb="BULL",1.0,0.0
        elif in_trend: ns,wt,wb="MIXED",0.6,0.4
        elif santa: ns,wt,wb="MIXED2",0.3,0.7
