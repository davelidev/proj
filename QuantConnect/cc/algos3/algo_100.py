...
class Algo100(QCAlgorithm):
    """#100 — Best-of-#075 design: regime switch with vol-50% calm threshold (slightly tighter)
    and EW basket. Final iteration optimizing entry threshold for higher TQQQ time share.
    """
    CALM_VOL = 0.50; PANIC_VOL = 0.85; TOP_N = 7
