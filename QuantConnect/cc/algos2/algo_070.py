...
class Algo070(QCAlgorithm):
    """#070 — Top-7 momo (3mo) + TQQQ vol-gate + 5d cooldown (replicate #059)."""
    LOOKBACK = 63; VOL_THRESH = 0.60; COOLDOWN = 5; TOP_N = 7
    ...
    def Initialize(self):
        ...
        self.basket = []; self.in_market = False; self.month_seen = -1; self.weights = {}; self.cooldown_left = 0
    ...
    def R(self):
        ...
        if on:
            ...
            if self.in_market:
                ...
                self.in_market = False; self.cooldown_left = self.COOLDOWN
