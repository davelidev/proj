...
> [!code]- Click to view: cc005_002.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_002.py"
> ```
...
> [!code]- Click to view: cc005_003.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_003.py"
> ```
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_004.py"
> ```
...
## Strategy-106
### 3-State 30/70 + 6% Trail (cc005_006.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_006.py"
> ```
...
## Strategy-107
### ROC+D200 + SHV Defense (cc005_007.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_007.py"
> ```
...
## Strategy-108
### Triple-AND ROC+Aroon+D200 (cc005_008.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_008.py"
> ```
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_009.py"
> ```
...
## Strategy-110
### Top-5 50% + 50% TQQQ Overlay (cc005_010.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_010.py"
> ```
...
## Strategy-115
### QQQ Range Position (cc005_015.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_015.py"
> ```
...
## Strategy-117
### Mega-Cap Dispersion Regime (cc005_017.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_017.py"
> ```
...
## Strategy-126
### Top-5 50% + 50% TQQQ Always-In (cc005_026.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_026.py"
> ```
...
## Strategy-136
### 3-State ROC(15)+D200 (cc005_036.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_036.py"
> ```
...
## Strategy-137
### 3-State ROC(25)+D200 (cc005_037.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_037.py"
> ```
...
## Strategy-138
### 3-State ROC(45)+D200 (cc005_038.py)
...
> [!code]- Click to view: cc005_038.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_038.py"
> ```
...
## Strategy-142
### 3-State ROC(50)+D200 (cc005_042.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_042.py"
> ```
...
## Strategy-143
### 3-State Dual-ROC(20,45)+D200 (cc005_043.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_043.py"
> ```
...
## Strategy-144
### 3-State ROC(20)+D175 (cc005_044.py)
...
> [!code]- Click to view: cc005_044.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_044.py"
> ```
...
## Strategy-145
### 3-State ROC(20)+D250 (cc005_045.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_045.py"
> ```
...
## Strategy-146
### 3-State ROC20+D175 70/30 (cc005_046.py)
...
> [!code]- Click to view: cc005_046.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_046.py"
> ```
...
## Strategy-147
### 3-State ROC20+D250 60/40 (cc005_047.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_047.py"
> ```
...
## Strategy-148
### 3-State ROC20+D125 50/50 (cc005_048.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_048.py"
> ```
...
## Strategy-149
### 3-State ROC20+D175 80/20 (cc005_049.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_049.py"
> ```
...
## Strategy-150
### 3-State ROC20+D225 70/30 (cc005_050.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc005_050.py"
> ```
