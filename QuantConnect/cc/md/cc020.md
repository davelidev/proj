...
> [!code]- Click to view: cc019_051.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc019_051.py"
> ```
...
## Strategy-1007
### Psych Line(20) >50.0 Bull (cc019_057.py)
...
> [!code]- Click to view: cc019_057.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc019_057.py"
> ```
