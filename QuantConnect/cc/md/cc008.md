...
---
## Strategy-210
### MFI(14) + Median-200 (cc008_010.py)
...
> [!code]- Click to view: cc008_010.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc008/cc008_010.py"
> ```
...
## Strategy-212
### Variance Ratio Test (cc008_012.py)
...
> [!code]- Click to view: cc008_012.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc008/cc008_012.py"
> ```
...
> [!code]- Click to view: cc008_023.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc008/cc008_023.py"
> ```
...
## Strategy-227
### Vol Contraction Regime (cc008_027.py)
...
> [!code]- Click to view: cc008_027.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc008/cc008_027.py"
> ```
...
> [!code]- Click to view: cc008_036.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc008/cc008_036.py"
> ```
...
## Strategy-239
### OBV Slope + Median 3-state (cc008_039.py)
...
> [!code]- Click to view: cc008_039.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc008/cc008_039.py"
> ```
...
## Strategy-243
### Avoid Mid-Month + Median (cc008_043.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc008/cc008_043.py"
> ```
