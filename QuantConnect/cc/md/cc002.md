...
| [60](#strategy-60)   | ❌    | Mean Reversion  | 27%  | -38%  | 0.832  | 37    | 22    | 1.68     | 2.88         | 3/10   |


---
## Strategy-1
### Volatility Squeeze Alpha (cc001_001.py)
...
## Strategy-2
### Research S38 - Vol Expansion + SOXL/TQQQ + VIX Shield (cc001_002.py)
...
## Strategy-3
### Research S36 - Triple-LETF Rotator + Expanding Range (cc001_003.py)
...
## Strategy-4
### Research S35 - Expanding Strong Trend + SOXL + ADX (cc001_004.py)
...
## Strategy-5
### Research S31 - Expanding Breakout + ADX + 3.0 ATR (cc001_005.py)
...
## Strategy-6
### Research S16 - Classic Expanding Breakout + 2.5 ATR (cc001_006.py)
...
## Strategy-7
### RSI Frankenfest v1.5 (cc001_007.py)
...
## Strategy-8
### Research S22 - High-Octane RSI Swing TQQQ (cc001_008.py)
...
## Strategy-9
### Research S11 - Cheat Code Rotator TQQQ (cc001_009.py)
...
## Strategy-10
### Conservative Rotation (cc001_010.py)
...
## Strategy-11
### Large Cap Dip Buy (cc001_011.py)
...
## Strategy-12
### Giant Sniper Mean-Reversion (cc001_012.py)
...
## Strategy-15
### SOXL.SOXS SeeSaw Duplicate (cc001_015.py)
...
## Strategy-16
### Rotation Strategy V1 (cc001_016.py)
...
## Strategy-17
### Defensive Rotation (cc001_017.py)
...
## Strategy-19
### TQQQ Simple Long Term (cc001_019.py)
...
## Strategy-20
### Large Cap Tech Strategy (cc001_020.py)
...
## Strategy-21
### Research S8 - TQQQ Dynamic Compounding (cc001_021.py)
...
## Strategy-22
### Equal-Weight LETF Rebalance (cc001_022.py)
...
## Strategy-23
### TQQQ trend SMA200 (cc001_023.py)
...
## Strategy-24
### TQQQ trend SMA150 (cc001_024.py)
...
## Strategy-29
### 5 most mkt cap @ 1.5x (cc001_029.py)
...
## Strategy-31
### TQQQ IBS 0.15/0.85 (cc001_031.py)
...
## Strategy-32
### IBS extreme + SMA200 (cc001_032.py)
...
## Strategy-33
### IBS extreme + ATR stop (cc001_033.py)
...
## Strategy-36
### IBS regime-adaptive (cc001_036.py)
...
## Strategy-38
### SMA150 trend + IBS<0.05 (cc001_038.py)
...
## Strategy-41
### SMA150+IBS fast exit (cc001_041.py)
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_042.py"
> ```
...
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_043.py"
> ```
...
> [!code]- Click to view: cc001_044.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_044.py"
> ```
...
> [!code]- Click to view: cc001_045.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_045.py"
> ```
...
> [!code]- Click to view: cc001_046.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_046.py"
> ```
...
## Strategy-47
### TQQQ hybrid (SMA+IBS) (cc001_047.py)
...
> [!code]- Click to view: cc001_047.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_047.py"
> ```
...
> [!code]- Click to view: cc001_048.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_048.py"
> ```
...
## Strategy-49
### 5 most mkt cap + IBS regime mix (cc001_049.py)
...
> [!code]- Click to view: cc001_049.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_049.py"
> ```
...
> [!code]- Click to view: cc001_050.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_050.py"
> ```
...
## Strategy-52
### 5x 3x-Leveraged ETF Basket + QQQ Vol Gate (cc001_052.py)
...
> [!code]- Click to view: cc001_052.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_052.py"
> ```
...
## Strategy-53
### Dynamic Top-5 EW + Adaptive Vol Gate (cc001_053.py)
...
> [!code]- Click to view: cc001_053.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_053.py"
> ```
...
## Strategy-54
### Dynamic Top-5 Momentum + TQQQ Sleeve + Vol Gate (cc001_054.py)
...
> [!code]- Click to view: cc001_054.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_054.py"
> ```
...
## Strategy-55
### QQQ SMA(200) Trend → TQQQ/BIL (cc001_055.py)
...
> [!code]- Click to view: cc001_055.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_055.py"
> ```
...
## Strategy-56
### QQQ SMA(200) + VIX < 30 Hybrid → TQQQ/BIL (cc001_056.py)
...
> [!code]- Click to view: cc001_056.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_056.py"
> ```
...
## Strategy-57
### QQQ SMA(200) + Vol Ratio Gate → TQQQ/BIL (cc001_057.py)
...
> [!code]- Click to view: cc001_057.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_057.py"
> ```
...
## Strategy-58
### QQQ SMA(200) + Stretch Filter → TQQQ/BIL (cc001_058.py)
...
> [!code]- Click to view: cc001_058.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_058.py"
> ```
...
## Strategy-59
### 4-State TQQQ/SOXL/UVIX Rotation, 3-of-4 Vote (cc001_059.py)
...
> [!code]- Click to view: cc001_059.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_059.py"
> ```
...
## Strategy-60
### Top-5 Tech RSI(2) Dip Buy, 15% Stop / ATH Exit (cc001_060.py)

**Description:** Dynamically selects the top 5 technology stocks by market cap. Buys a dip in any when RSI(2) drops below 30 while price stays above SMA(50), allocating up to 20% per slot. Exits each position on a 15% hard stop or when price reaches its 1-year high. Checks only on Mondays.

*Overfit 3/10 — Four parameters: RSI(2) threshold 30, SMA period 50, stop loss 15%, ATH lookback 252 days. All are widely used textbook values. The Monday-only cadence is a timing choice but avoids over-trading.*

- **Universe:** Top 5 US tech stocks by market cap (MorningstarSectorCode.Technology, HasFundamentalData)
- **Entry:** RSI(2) < 30 AND price > SMA(50): up to 20% per slot
- **Stop loss:** Price ≤ average cost × 0.85: liquidate position
- **Take profit:** Price ≥ 252-day high: liquidate position
...
> [!code]- Click to view: cc001_060.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc001_060.py"
> ```
