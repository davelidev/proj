...
| [55](#strategy-55)   | ✅    | Trend Following | 34%  | -56%  | 0.757  | 36    | 77    | 0.47     | 13.25        | 2/10   |
| [56](#strategy-56)   | ✅    | Trend Following | 28%  | -56%  | 0.67   | 55    | 102   | 0.54     | 6.85         | 3/10   |
| [57](#strategy-57)   | ✅    | Trend Following | 33%  | -57%  | 0.741  | 57    | 88    | 0.65     | 7.28         | 3/10   |
| [58](#strategy-58)   | ✅    | Trend Following | 36%  | -56%  | 0.82   | 48    | 89    | 0.54     | 7.88         | 3/10   |
| [59](#strategy-59)   | ✅    | Rotation        | 136% | -47%  | 1.978  | 2184  | 1282  | 1.70     | 1.80         | 5/10   |


---
## Strategy-2
### Research S38 - Vol Expansion + SOXL/TQQQ + VIX Shield (cc002_002.py)
...
> [!code]- Click to view: cc002_002.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_002.py"
> ```
...
## Strategy-3
### Research S36 - Triple-LETF Rotator + Expanding Range (cc002_003.py)
...
> [!code]- Click to view: cc002_003.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_003.py"
> ```
...
## Strategy-4
### Research S35 - Expanding Strong Trend + SOXL + ADX (cc002_004.py)
...
> [!code]- Click to view: cc002_004.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_004.py"
> ```
...
## Strategy-5
### Research S31 - Expanding Breakout + ADX + 3.0 ATR (cc002_005.py)
...
> [!code]- Click to view: cc002_005.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_005.py"
> ```
...
## Strategy-6
### Research S16 - Classic Expanding Breakout + 2.5 ATR (cc002_006.py)
...
> [!code]- Click to view: cc002_006.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_006.py"
> ```
...
## Strategy-7
### RSI Frankenfest v1.5 (cc002_007.py)
...
> [!code]- Click to view: cc002_007.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_007.py"
> ```
...
## Strategy-8
### Research S22 - High-Octane RSI Swing TQQQ (cc002_008.py)
...
> [!code]- Click to view: cc002_008.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_008.py"
> ```
...
## Strategy-9
### Research S11 - Cheat Code Rotator TQQQ (cc002_009.py)
...
> [!code]- Click to view: cc002_009.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_009.py"
> ```
...
## Strategy-10
### Conservative Rotation (cc002_010.py)
...
> [!code]- Click to view: cc002_010.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_010.py"
> ```
...
## Strategy-11
### Large Cap Dip Buy (cc002_011.py)
...
> [!code]- Click to view: cc002_011.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_011.py"
> ```
...
> [!code]- Click to view: cc002_014.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_014.py"
> ```
...
## Strategy-15
### SOXL.SOXS SeeSaw Duplicate (cc002_015.py)
...
> [!code]- Click to view: cc002_015.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_015.py"
> ```
...
## Strategy-16
### Rotation Strategy V1 (cc002_016.py)
...
> [!code]- Click to view: cc002_016.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_016.py"
> ```
...
## Strategy-17
### Defensive Rotation (cc002_017.py)
...
> [!code]- Click to view: cc002_017.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_017.py"
> ```
...
> [!code]- Click to view: cc002_018.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_018.py"
> ```
...
## Strategy-19
### TQQQ Simple Long Term (cc002_019.py)
...
> [!code]- Click to view: cc002_019.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_019.py"
> ```
...
## Strategy-20
### Large Cap Tech Strategy (cc002_020.py)
...
> [!code]- Click to view: cc002_020.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_020.py"
> ```
...
## Strategy-21
### Research S8 - TQQQ Dynamic Compounding (cc002_021.py)
...
> [!code]- Click to view: cc002_021.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_021.py"
> ```
...
## Strategy-22
### Equal-Weight LETF Rebalance (cc002_022.py)
...
> [!code]- Click to view: cc002_022.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_022.py"
> ```
...
## Strategy-23
### TQQQ trend SMA200 (cc002_023.py)
...
> [!code]- Click to view: cc002_023.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_023.py"
> ```
...
## Strategy-24
### TQQQ trend SMA150 (cc002_024.py)
...
> [!code]- Click to view: cc002_024.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_024.py"
> ```
...
> [!code]- Click to view: cc002_025.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_025.py"
> ```
...
> [!code]- Click to view: cc002_026.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_026.py"
> ```
...
> [!code]- Click to view: cc002_027.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_027.py"
> ```
...
> [!code]- Click to view: cc002_028.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_028.py"
> ```
...
## Strategy-29
### 5 most mkt cap @ 1.5x (cc002_029.py)
...
> [!code]- Click to view: cc002_029.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_029.py"
> ```
...
> [!code]- Click to view: cc002_030.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_030.py"
> ```
...
## Strategy-31
### TQQQ IBS 0.15/0.85 (cc002_031.py)
...
> [!code]- Click to view: cc002_031.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_031.py"
> ```
...
## Strategy-32
### IBS extreme + SMA200 (cc002_032.py)
...
> [!code]- Click to view: cc002_032.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_032.py"
> ```
...
## Strategy-33
### IBS extreme + ATR stop (cc002_033.py)
...
> [!code]- Click to view: cc002_033.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_033.py"
> ```
...
> [!code]- Click to view: cc002_034.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_034.py"
> ```
...
> [!code]- Click to view: cc002_035.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_035.py"
> ```
...
## Strategy-36
### IBS regime-adaptive (cc002_036.py)
...
> [!code]- Click to view: cc002_036.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_036.py"
> ```
...
> [!code]- Click to view: cc002_037.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_037.py"
> ```
...
## Strategy-38
### SMA150 trend + IBS<0.05 (cc002_038.py)
...
> [!code]- Click to view: cc002_038.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_038.py"
> ```
...
> [!code]- Click to view: cc002_039.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_039.py"
> ```
...
> [!code]- Click to view: cc002_040.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_040.py"
> ```
...
## Strategy-41
### SMA150+IBS fast exit (cc002_041.py)
...
> [!code]- Click to view: cc002_041.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_041.py"
> ```
...
> [!code]- Click to view: cc002_042.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_042.py"
> ```
...
> [!code]- Click to view: cc002_043.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_043.py"
> ```
...
> [!code]- Click to view: cc002_044.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_044.py"
> ```
...
> [!code]- Click to view: cc002_045.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_045.py"
> ```
...
> [!code]- Click to view: cc002_046.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_046.py"
> ```
...
## Strategy-47
### TQQQ hybrid (SMA+IBS) (cc002_047.py)
...
> [!code]- Click to view: cc002_047.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_047.py"
> ```
...
> [!code]- Click to view: cc002_048.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_048.py"
> ```
...
## Strategy-49
### 5 most mkt cap + IBS regime mix (cc002_049.py)
...
> [!code]- Click to view: cc002_049.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_049.py"
> ```
...
> [!code]- Click to view: cc002_050.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_050.py"
> ```
...
## Strategy-53
### Dynamic Top-5 EW + Adaptive Vol Gate (cc002_053.py)
...
> [!code]- Click to view: cc002_053.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_053.py"
> ```
...
## Strategy-54
### Dynamic Top-5 Momentum + TQQQ Sleeve + Vol Gate (cc002_054.py)
...
> [!code]- Click to view: cc002_054.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_054.py"
> ```
...
## Strategy-55
### QQQ SMA(200) Trend → TQQQ/BIL (cc002_055.py)
...
> [!code]- Click to view: cc002_055.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_055.py"
> ```
...
## Strategy-56
### QQQ SMA(200) + VIX < 30 Hybrid → TQQQ/BIL (cc002_056.py)
...
> [!code]- Click to view: cc002_056.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_056.py"
> ```
...
## Strategy-57
### QQQ SMA(200) + Vol Ratio Gate → TQQQ/BIL (cc002_057.py)
...
> [!code]- Click to view: cc002_057.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_057.py"
> ```
...
## Strategy-58
### QQQ SMA(200) + Stretch Filter → TQQQ/BIL (cc002_058.py)
...
> [!code]- Click to view: cc002_058.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_058.py"
> ```
...
## Strategy-59
### 4-State TQQQ/SOXL/UVIX Rotation, 3-of-4 Vote (cc002_059.py)
...
> [!code]- Click to view: cc002_059.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc002/cc002_059.py"
> ```
