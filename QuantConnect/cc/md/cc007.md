...
---
## Strategy-210
### MFI(14) + Median-200 (cc007_010.py)
...
> [!code]- Click to view: cc007_010.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007_010.py"
> ```
...
## Strategy-212
### Variance Ratio Test (cc007_012.py)
...
> [!code]- Click to view: cc007_012.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007_012.py"
> ```
...
> [!code]- Click to view: cc007_023.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007_023.py"
> ```
...
## Strategy-227
### Vol Contraction Regime (cc007_027.py)
...
> [!code]- Click to view: cc007_027.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007_027.py"
> ```
...
> [!code]- Click to view: cc007_036.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007_036.py"
> ```
...
## Strategy-239
### OBV Slope + Median 3-state (cc007_039.py)
...
> [!code]- Click to view: cc007_039.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007_039.py"
> ```
...
## Strategy-243
### Avoid Mid-Month + Median (cc007_043.py)
...
> [!code]- Click to view: cc007_043.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007_043.py"
> ```
