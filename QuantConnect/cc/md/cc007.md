...
---
## Strategy-151
### 3-State ROC20+D300 (cc007_001.py)
...
> [!code]- Click to view: cc007_001.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_001.py"
> ```
...
## Strategy-152
### 3-State ROC20+D150 70/30 (cc007_002.py)
...
> [!code]- Click to view: cc007_002.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_002.py"
> ```
...
## Strategy-153
### ROC+D100+D250 Consensus (cc007_003.py)
...
> [!code]- Click to view: cc007_003.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_003.py"
> ```
...
## Strategy-154
### ROC+D200 + 7% Trail Binary (cc007_004.py)
...
> [!code]- Click to view: cc007_004.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_004.py"
> ```
...
## Strategy-155
### ROC+D200 + 4% Trail Binary (cc007_005.py)
...
> [!code]- Click to view: cc007_005.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_005.py"
> ```
...
> [!code]- Click to view: cc007_007.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_007.py"
> ```
...
## Strategy-164
### 3-State CMO+Median200 (cc007_014.py)
...
> [!code]- Click to view: cc007_014.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_014.py"
> ```
...
## Strategy-165
### 3-State Aroon+CMO (cc007_015.py)
...
> [!code]- Click to view: cc007_015.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_015.py"
> ```
...
## Strategy-166
### 3-State Aroon+CMO 70/30 (cc007_016.py)
...
> [!code]- Click to view: cc007_016.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_016.py"
> ```
...
## Strategy-169
### 3-State CMO+52w-High Gate (cc007_019.py)
...
> [!code]- Click to view: cc007_019.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_019.py"
> ```
...
## Strategy-171
### CMO + Top-1 Mega-Cap Defense (cc007_021.py)
...
> [!code]- Click to view: cc007_021.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_021.py"
> ```
...
## Strategy-175
### 3-State Aroon-Osc + CMO (cc007_025.py)
...
> [!code]- Click to view: cc007_025.py
> ```embed-python
> PATH: "vault://QuantConnect/cc/cc_algos/cc007/cc007_025.py"
> ```
