...
class RotationStrategyV12(QCAlgorithm):
    """
    Rotation V12: Faster Bear Market Rotation
    Uses a 10-day SMA for TQQQ (instead of 20-day) to cut losses faster 
    during failed bear market rallies.
    """
    def Initialize(self):
        ...
        self.sma_tqqq10 = self.SMA(self.syms["TQQQ"], 10,  Resolution.Daily) # Fast SMA!
    ...
    def _pick(self) -> str:
        ...
        short_term_bear = tqqq_price < self.sma_tqqq10.Current.Value
    ...
    def Rebalance(self):
        if (self.IsWarmingUp 
            ...
            or not self.sma_tqqq10.IsReady 
